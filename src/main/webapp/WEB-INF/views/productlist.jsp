...
2 1300.0 Product Description Book 2
 -->
	<div class="container">
		...
		<table id="pdtTable" class="table table-hover" border="2">
			<thead id="thead">
				<tr>
					<th>Image</th>
					<th>ProductName</th>
			...
			<tbody id="tbody">
				<c:forEach items="${productsAttr}" var="p">
					<tr>
						<!-- p.getProductName() -->
						<!-- p.getPrice() -->
						<td><img src='<c:url value="/resources/images/${p.getId()}.png">
							</c:url>' alt ="image not available" style="width:100px"></td>
						<td>${p.productname }</td>
